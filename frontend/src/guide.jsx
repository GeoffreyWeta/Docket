...
const G = {
  procurement: {
    ...
    steps: [
      ...
      ["Award", "Once the panel has scored, recommend a winner — the memo writes itself and goes to the approver. Letters issue automatically on sign-off."],
  ...
  evaluator: {
    ...
    steps: [
      ...
      ["Sign the declaration", "Scoring is locked until you sign the conflict-of-interest declaration — it's recorded in the audit trail."],
  ...
  supplier: {
    ...
    steps: [
      ...
      ["Stay eligible", "You're reminded before your documents expire — renew them from your profile to keep getting invited."],
    ],
  },
};
